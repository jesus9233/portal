...
class PatientController {
                    ...
                    <div class="modal-body" data-keyboard="false" data-backdrop="static" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="md-form mt-0">
                              <!-- <input class="typeahead form-control" type="text" id="suggest" aria-label="Search for Code" placeholder="Search for Code" value="" name="suggest"> -->
    ...
    public static function getPatientDetail($pdo) {
        ...
        if (!empty($result)) {
            ...
            $query = "SELECT icd.icd_id as icdId,icd.cat_id as catId,pic.id,pic.icd_code,icd.icd_desc,icd.icd_secondary_ranking,icd.icd_ranking "
            ...
            if (!empty($code_result)) {
                foreach ($code_result as $key => $value) {
                    ...
                    //CB10-10
                    //Red 
                    $catSql = "SELECT * from category WHERE cat_id = ".$value['catId']."";
