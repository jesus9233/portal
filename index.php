...
<body screen_capture_injected="true">
                    ...
                    <ul class="navbar-nav nav-flex-icons">
                        <li class="nav-item">
                            <?php if (isset($_SESSION['username'])) : ?>
                                <a href="<?php echo getLink("index.php?logout='1'") ?>" class="nav-link waves-effect"><i class="fas fa-sign-out-alt"></i> </a>
                            <?php endif ?>
                            </a>
                        </li>
                    </ul>
    ...
    <main>
        ...
        <div class="modal modal-print fade" id="centralModalSuccess" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            ...
            $(addButton).click(function() {
                ...
                if (x < maxField) {
                    ...
                    if ($('#ranking_text:contains("Return to Provider")').length > 0) {
                        ...
                        if (cartRank == 1.5 || cartRank == 1.4 || cartRank == 1.3 || cartRank == 1.2 || cartRank == 1.1 || cartRank == 1.0) {
                            //li must be first child
                            $('#ulcart').append('<li class="list-unstyled desc item ui-state-default cartid_' +
                                cartID + '" data-cart-id = "' + cartID + '" data-order="' + cartRank +
                                '"><h5 class=" mt-1 mb-1 cart-rank font-weight-bold" style="color: red;"> ' + cartID +
                            ...
                            //li must be last child
                            $('#ulcart').append('<li class="list-unstyled aesc item ui-state-default cartid_' +
                                cartID + '" data-cart-id = "' + cartID + '" data-order="' + cartRank +
                                '"><h5 class=" mt-1 mb-1 cart-rank font-weight-bold" style="color: red;"> ' + cartID +
                                '<span style="display:none" class="icd_tertiary_ranking">(' +
                                icd_tertiary_ranking +
                        ...
                        // let ul = $('#ulcart');
                        // // Auto Sort except icd with order 1.5 What if icd is 1.5 and name is not B20?
                        // $('li', ul).sort(function(a, b) {
                        //     if ($(a).data('cart-id') == 'B20') {
                        //         return;
                        //     }
                        //     return $(a).data('order') - $(b).data('order');
                        // }).appendTo('#ulcart');
                        // //Iterating and putting icd 1.2 at last of list What if icd is 1.2 and name is not C000
                        // $('li', ul).each(function(i, li) {
                        //     if ($(this).data('cart-id') == 'C000') {
                        //         $(this).appendTo('#ulcart');
                        //     }
                        // });
                        ...
                        // $( "li.desc" ).each(function( index ) {
                        //     console.log( index + ": " + $( this ).text() );
                        //     });
                        // $( "li.aesc" ).each(function( index ) {
                        //     console.log( index + ": " + $( this ).text() );
                        //     });
